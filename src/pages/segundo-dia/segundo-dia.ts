    ...
    this.chamadas = [
      {header: 'Programação do dia', conteudo: `09:00 - 10:30 <br>
        ...
        {header: 'Detalhes das Sessões Técnicas', conteudo: `Sessão Técnica 5 (ST5) - Decision Support Systems (2): <br>
                                                            ...
                                                            &nbsp; &nbsp; &nbsp;- Hallan Medeiros, Patrícia Vilain, <br>
                                                            ...
                                                            &nbsp; &nbsp; &nbsp;- Claudia Cappelli (UFRJ) <br><br>`},

      {header: 'Master Class 1 - Fundamentos dos SI', conteudo: `<b>Resumo:</b> O objetivo desta aula é apresentar fundamentos teóricos e metodológicos para pesquisa em Sistemas de Informação (SI) 
